...
@WebService(endpointInterface="generic.util.interaction.mail.SendMailWebService")
public class RemoteMailUserInteraction implements AsyncUserInteraction , SendMailWebService{
	
	private static Logger logger = LoggerFactory.getLogger(RemoteMailUserInteraction.class);
	
	private String smtpHost;
	private String defaultFrom;
	
	public RemoteMailUserInteraction() {
		super();
		this.smtpHost="localhost"; //by default
		this.defaultFrom = "no-reply@localhost";//by default
	}
	
	public RemoteMailUserInteraction(String smtpHost, String defaultFrom) {
		super();
		this.smtpHost = smtpHost;
		this.defaultFrom = defaultFrom;
	}
	
	public RemoteMailUserInteraction(String smtpHost) {
